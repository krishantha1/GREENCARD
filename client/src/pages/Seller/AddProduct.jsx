...
const AddProduct = () => {
    ...
    return (
        <div className="no-scrollbar flex-1 h-[95vh] overfalow-y-scroll flex flex-col justify-between">
            <form  onSubmit={onSubmitHandiler} className="md:p-10 p-4 space-y-5 max-w-lg">
                <div>
                ...
                <div className="flex flex-col gap-1 max-w-md">
                    ...
                    <input   onChange={(e)=>  setName(e.target.value)}  vlaue={name}
                ...
                <div className="flex flex-col gap-1 max-w-md">
                    ...
                    <textarea onChange={(e)=>  setDescription(e.target.value)}  vlaue={description}
                ...
                <div className="w-full flex flex-col gap-1">
                    ...
                    <select
                     onChange={(e)=>  setCategory(e.target.value)}  vlaue={category}
                ...
                <div className="flex items-center gap-5 flex-wrap">
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        ...
                        <input
                        onChange={(e)=>  setPrice(e.target.value)}  vlaue={price}
                    ...
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        ...
                        <input onChange={(e)=>  setOfferPrice(e.target.value)}  vlaue={offerPrice}
